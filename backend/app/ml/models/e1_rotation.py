"""
YatraSaarthi ML - E1 Rotation Robustness Ablation Model
Architecture: 1D CNN (kernel=3, 2 layers) + GRU (1 layer) + FC regressor.
Trained with 3D rotation augmentation only.
Parameters: 134,083.
Status: FAILED / DEGRADED (Generalization R2 = -1.12 on unseen driver).
